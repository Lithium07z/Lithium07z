...
<a href="https://developer.android.com/studio/index.html" target="_blank"><img src="https://img.shields.io/badge/Android Studio-3DDC84?style=flat-square&logo=AndroidStudio&logoColor=FFFFFF"/></a>
</p>
...
- **가상융합 콘텐츠에 대한 감정-감성 반응의정량 평가 기술 개발**
  - 수행 기간: 2026.04 ~ 2027.02
- **몰입형 문화체험을 위한 멀티모달 기반 융합형 인터랙티브 서비스 기술 개발**
  - 수행 기간: 2026.04 ~ 2027.02
- **사용자 다감각 및 실세계 멀티모달 입력에 기반한 지능형 XR 상호작용 자동화 연구**
  - 수행 기간: 2026.03 ~ 2027.02
- **XR 환경에서 전력설비 감시 시스템의 사용자 경험 향상을 위한 SCADA UI 모듈 설계 및 구현**
  - 수행 기간: 2026.02 ~ 2026.08
- **전력설비 감시 시스템의 사용자 경험 향상을 위한 기반 SCADA UI 모듈 설계 및 구현에 관한 연구**
  - 수행 기간: 2025.08 ~ 2026.01
- **핵융합 디지털 트윈을 위한 플라즈마의 3차원 가시화 및 시뮬레이션 데이터 분석 기술 개발**
  - 수행 기간: 2024.07 ~ 2025.12
...
| 1st | 하드웨어 센서 정보를 이용한 안드로이드 에뮬레이터 탐지 기법 | [CISC-W 2024](https://cisc.or.kr/) | Gwangju-si, Gyeonggi-do, Korea (Nov. 2024) | Poster |
| 1st | 모바일 증강현실 및 LLM 기반 여행지 추천 어플리케이션 | [HCI 2025](https://conference.hcikorea.org/hcik2025/main/main.asp) | Hongcheon, Korea (Feb. 2025) | Poster |
...
| 3rd | Olfactory Perception and Spatial Reliability: A Comparative Study of Fixed and Mounted Devices in VR | [ISMAR 2025](https://www.ieeeismar.net/2025/) | Yuseong-gu, Daejeon, Korea (Oct. 2025) | Poster |
| 3rd | Can Smell Guide You Home? Evaluating Olfactory Cues in VR Navigation | [ISMAR 2025](https://www.ieeeismar.net/2025/) | Yuseong-gu, Daejeon, Korea (Oct. 2025) | Poster |
...
| 활동명 | 담당기관 | 날짜 |
|:---|:---:|:---:|
| 오픈소스 컨트리뷰션 아카데미 지역 스프린트 @춘천 수료 | Open Up | 2022.05 |
...
| 수상 | 수상명 | 수상기관 | 날짜 |
|:---:|:---|:---|:---:|
| 🥈 우수상 | 심비우스 에세이 공모전 | 한림대학교 일송자유교양대학 | 2022.05 |
| 🥉 동상 | SW Week SW미래기술 특허 아이디어 경진대회 <br>*(중복 수상 불가, 포기)* | 한림대학교 SW사업단 | 2022.11 |
| 🥉 동상 | SW Week Coding Festival | 한림대학교 SW사업단 | 2022.11 |
| 🥈 우수상 | 심비우스 에세이 공모전 | 한림대학교 일송자유교양대학 | 2023.05 |
| 🥈 은상 | SW Week GitHub 이력서 해커톤 | 한림대학교 SW사업단 | 2023.11 |
...
| 🥈 우수상 | 글로벌 AI 인재양성 챌린지 | 과학기술정보통신부 · 강릉과학산업진흥원 · 강원정보문화산업진흥원 | 2025.09 |
| 🥈 우수상 | [L-HUSS X 국어국문] 촌철살인(寸鐵殺人) 공모전 | 한림대학교 인문사회융합인재양성사업단 · 한림대학교 인문대학 국어국문학전공 | 2025.11 |
...
### 2026
- 가상융합 콘텐츠에 대한 감정-감성 반응의정량 평가 기술 개발 — **개발자**
- 몰입형 문화체험을 위한 멀티모달 기반 융합형 인터랙티브 서비스 기술 개발 — **개발자**
- 사용자 다감각 및 실세계 멀티모달 입력에 기반한 지능형 XR 상호작용 자동화 연구 — **개발자**
- XR 환경에서 전력설비 감시 시스템의 사용자 경험 향상을 위한 SCADA UI 모듈 설계 및 구현 — **개발자**

### 2025
- 전력설비 감시 시스템의 사용자 경험 향상을 위한 기반 SCADA UI 모듈 설계 및 구현에 관한 연구 — **개발자**
- 핵융합 디지털 트윈을 위한 플라즈마의 3차원 가시화 및 시뮬레이션 데이터 분석 기술 개발 — **개발자**

### 2024
- 핵융합 디지털 트윈을 위한 플라즈마의 3차원 가시화 및 시뮬레이션 데이터 분석 기술 개발 — **개발자**
- 소프트웨어학부 SW 전공 멘토링 — **멘토** *(Unity 게임제작기초)*
- 소프트웨어학부 한림 멘토링 — **멘토** *(자바 프로그래밍1)*
- 2024년도 1학기 캡스톤디자인 경진대회 — **팀장**

### 2023
- 난청 노인을 위한 ICT 기반 중추청각인지 재활 콘텐츠 구축 — **개발자**
- GVE Lab. 학부 연구생 등록
- 알고리즘 트레이닝 사이트 창업 동아리 COU 입부

### 2022
- 한림대학교 소프트웨어학부 SW 학술동아리 멀티플렉스 입부
